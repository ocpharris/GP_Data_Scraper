# this code assumes that gp+practice_level_sept2023.xlsx is already downloaded 
import argparse
import pandas as pd
import requests     
import numpy as np
...
def extract_and_merge_data(postcode, formatted_date):
    ...
    # Define the path to the Excel file relative to the script directory
    excel_file_path = os.path.join(script_dir, "gp_practice_level_sept2023.xlsx")
